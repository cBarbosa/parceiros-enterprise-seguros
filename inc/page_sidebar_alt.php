...
<div id="sidebar-alt" tabindex="-1" aria-hidden="true">
    ...
    <div id="sidebar-scroll-alt">
        ...
        <div class="sidebar-content">
            ...
            <div class="sidebar-section">
                ...
                <form action="index.php" method="post" class="form-control-borderless" onsubmit="return false;">
                    <div class="form-group">
                        ...
                        <input type="text" id="side-profile-name" name="side-profile-name" class="form-control" value="<?php echo($_SESSION['tmp']->nome)?>">
                    </div>
                    <div class="form-group">
                        <label for="side-profile-email">Email</label>
                        <input type="email" id="side-profile-email" name="side-profile-email" class="form-control" value="<?php echo($_SESSION['tmp']->email)?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="side-profile-password-confirm">Confirma Nova Senha</label>
            ...
            <!-- Settings -->
            <div class="sidebar-section">
                <h2 class="text-light"><?php echo htmlentities("Configurações", ENT_COMPAT,'ISO-8859-1', true); ?></h2>
                <form action="index.php" method="post" class="form-horizontal form-control-borderless" onsubmit="return false;">
                    <div class="form-group">
                        <label class="col-xs-7 control-label-fixed">Notifica</label>
                        <div class="col-xs-5">
                            <label class="switch switch-success"><input type="checkbox" checked><span></span></label>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-7 control-label-fixed">Perfil Public</label>
                        <div class="col-xs-5">
                            <label class="switch switch-success"><input type="checkbox" checked><span></span></label>
                        </div>
                    </div>
