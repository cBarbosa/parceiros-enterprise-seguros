...
/* Template variables */
$template = array(
    'name'              => 'ENTERPRISE SEGUROS',
    'version'           => '1.0',
    'author'            => 'Agencia2.biz',
    'robots'            => 'noindex, nofollow',
    'title'             => 'ENTERPRISE SEGUROS - BackOffice',
    'description'       => 'Aplicação BackOffice para operadoras do produto Seguro Proteção de Ingresso',
	...
	*/
	array(
        ...
        'sub'   => array(
            array(
                'name'  => 'Nova Venda',
                'url'   => 'page_form_vendadireta.php'
            ),
			array(
                'name'  => 'Pré Cadastro',
                'url'   => 'page_form_cadastro_cliente.php'
            )
		)
	),
	array(
        ...
        'sub'   => array(
            array(
                ...
                'url'   => 'page_form_vendasefetuadas.php'
            ),
			array(
                'name'  => 'Pendência',
                'url'   => 'page_form_vendaspendentes.php'
            )
		)
	)
);