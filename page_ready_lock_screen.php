...
<div id="login-container">
    ...
    <h1 class="text-center text-light push-top-bottom animation-fadeInQuick">
        <strong><?php echo($_SESSION['tmp']->nome)?></strong><br>
        <small><em>Administrador</em></small>
    </h1>
    <!-- END Lock Header -->

    <!-- Lock Form -->
    <form action="autentica.php" method="post" class="form-horizontal push animation-fadeInQuick">
        <div class="form-group">
            <div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2">
                <div class="input-group input-group-lg">
                    <input type="password" id="lock-password" name="lock-password" class="form-control form-control-borderless" placeholder="Digite sua senha..">
    ...
    <p class="text-center animation-fadeInQuick">
        <a href="index.php"><small>Não é <?php echo($_SESSION['tmp']->nome)?>?</small></a>
    </p>
    <!-- END Lock Form -->
</div>
<!-- END Login Container -->
