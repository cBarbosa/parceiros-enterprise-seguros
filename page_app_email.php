...
<div id="page-content" class="inner-sidebar-left">
    ...
    <div id="page-content-sidebar">
        ...
        <div class="block-section">
            <a href="#modal-compose" class="btn btn-effect-ripple btn-block btn-success" data-toggle="modal"><i class="fa fa-pencil"></i> Compose Message OPA</a>
        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title"><strong>Compose Message OPAAA</strong></h3>
                    </div>
